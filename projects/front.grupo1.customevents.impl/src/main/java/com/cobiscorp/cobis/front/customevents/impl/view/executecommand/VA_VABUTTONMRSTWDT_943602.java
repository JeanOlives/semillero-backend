/*
 * Archivo: VA_VABUTTONMRSTWDT_943602.java
 *
...
@Properties(value={
		@Property(name = "view.id", value = "VW_ESTUDIANFF_602"),
		@Property(name = "view.version", value = "1.0.0"),
		@Property(name = "view.controlId", value = "VA_VABUTTONMRSTWDT_943602")})

public class VA_VABUTTONMRSTWDT_943602 implements IExecuteCommand {
	/**
	 * Instancia de Logger
	 */
	private static final ILogger logger = LogFactory.getLogger(VA_VABUTTONMRSTWDT_943602.class);
