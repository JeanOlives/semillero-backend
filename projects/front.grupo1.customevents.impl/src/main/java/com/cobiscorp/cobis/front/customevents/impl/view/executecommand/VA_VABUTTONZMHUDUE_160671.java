/*
 * Archivo: VA_VABUTTONZMHUDUE_160671.java
 *
...
@Properties(value={
		@Property(name = "view.id", value = "VW_ESTUDIANRG_671"),
		@Property(name = "view.version", value = "1.0.0"),
		@Property(name = "view.controlId", value = "VA_VABUTTONZMHUDUE_160671")})

public class VA_VABUTTONZMHUDUE_160671 implements IExecuteCommand {
	/**
	 * Instancia de Logger
	 */
	private static final ILogger logger = LogFactory.getLogger(VA_VABUTTONZMHUDUE_160671.class);
	...
	public void executeCommand(DynamicRequest arg0, IExecuteCommandEventArgs arg1) {
		...
		try {
			if (logger.isDebugEnabled()) {
				logger.logDebug("Start executeCommand in VA_VABUTTONZMHUDUE_160671");
			}
