/*
 * Archivo: VA_VABUTTONMYGZIEQ_326726.java
 *
...
@Properties(value={
		@Property(name = "view.id", value = "VW_ESTUDIANST_726"),
		@Property(name = "view.version", value = "1.0.0"),
		@Property(name = "view.controlId", value = "VA_VABUTTONMYGZIEQ_326726")})

public class VA_VABUTTONMYGZIEQ_326726 implements IExecuteCommand {
	/**
	 * Instancia de Logger
	 */
	private static final ILogger logger = LogFactory.getLogger(VA_VABUTTONMYGZIEQ_326726.class);
	...
	public void executeCommand(DynamicRequest arg0, IExecuteCommandEventArgs arg1) {
		...
		try {
			if (logger.isDebugEnabled()) {
				logger.logDebug("Start executeCommand in VA_VABUTTONMYGZIEQ_326726");
			}
