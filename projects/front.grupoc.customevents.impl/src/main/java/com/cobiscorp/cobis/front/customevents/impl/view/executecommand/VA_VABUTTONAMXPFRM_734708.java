/*
 * Archivo: VA_VABUTTONAMXPFRM_734708.java
 *
...
@Properties(value={
		@Property(name = "view.id", value = "VW_ESTUDIANTC_708"),
		@Property(name = "view.version", value = "1.0.0"),
		@Property(name = "view.controlId", value = "VA_VABUTTONAMXPFRM_734708")})

public class VA_VABUTTONAMXPFRM_734708 implements IExecuteCommand {
	/**
	 * Instancia de Logger
	 */
	private static final ILogger logger = LogFactory.getLogger(VA_VABUTTONAMXPFRM_734708.class);
	...
	public void executeCommand(DynamicRequest arg0, IExecuteCommandEventArgs arg1) {
		...
		try {
			if (logger.isDebugEnabled()) {
				logger.logDebug("Start executeCommand in VA_VABUTTONAMXPFRM_734708");
			}
