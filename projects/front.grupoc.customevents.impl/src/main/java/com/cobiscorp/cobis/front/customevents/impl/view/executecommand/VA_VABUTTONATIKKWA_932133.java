/*
 * Archivo: VA_VABUTTONATIKKWA_932133.java
 *
...
@Properties(value={
		@Property(name = "view.id", value = "VW_ESTUDIANDM_133"),
		@Property(name = "view.version", value = "1.0.0"),
		@Property(name = "view.controlId", value = "VA_VABUTTONATIKKWA_932133")})

public class VA_VABUTTONATIKKWA_932133 implements IExecuteCommand {
	/**
	 * Instancia de Logger
	 */
	private static final ILogger logger = LogFactory.getLogger(VA_VABUTTONATIKKWA_932133.class);
	...
	public void executeCommand(DynamicRequest arg0, IExecuteCommandEventArgs arg1) {
		...
		try {
			if (logger.isDebugEnabled()) {
				logger.logDebug("Start executeCommand in VA_VABUTTONATIKKWA_932133");
			}
